...
# 2. La función debe tomar dos argumentos: `largo` y `ancho`.
# 3. Dentro de la función, calcula el área (largo * ancho).
# 4. La función debe devolver el área calculada usando la sentencia `return`.
# --------------------------------------------------------------------------
...
def calcular_area_rectangulo(largo, ancho):
    ...
    area =  largo * ancho # Escribe aquí la operación matemática.
